    ...
    try {
      ...
      if (policyTemplate && packageInfo.name) {
        ...
        if (requestingGroup) {
          ...
          // existingCloudConnectorId is a UUID generated by the saved objects service and
          // cannot contain KQL special characters — safe to interpolate directly (same
          // pattern used in CloudConnectorService.getPackagePolicyCountsForConnector).
